...
bool syntacticParse()
{
    ...
    if (possibleQueryType == "ALTER" && tokenizedQuery[1] == "TABLE")
        return syntacticParseALTERTABLE();
...
void ParsedQuery::clear()
{
    ...
    this->alterTableRelationName = "";
    this->alterTableOperationName = "";
    this->alterTableColumnName = "";
